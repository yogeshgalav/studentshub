...
class CreateForeignKeyForChatroomMessagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('classroom_messages', function (Blueprint $table) {
            ...
            $table->foreign('parent_message_id', 'cm_parent_message_id_foreign')->references('id')->on('classroom_messages')->onDelete('cascade');
        });
    }
