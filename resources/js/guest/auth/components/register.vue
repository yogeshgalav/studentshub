...
<div>
    ...
    <div class="row justify-content-center">
     ...
     <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="full_name" class="col-md-4 col-form-label text-md-right">{{ trans('Your Name') }}</label>

                            <div class="col-md-6">
                                <input id="full_name" type="text" class="form-control" name="full_name"  autofocus v-validate="'required'">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" ref="password" type="password" class="form-control" name="password"  v-validate="'required'">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation"  v-validate="'required|confirmation:password'">
