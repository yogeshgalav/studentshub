  ...
  <div class="row"> 
    <div class="col-md-12 mt-1">
      <article>    
        ...
        <h6>There are basically five primary functions of management. These are:</h6>
        <ul>
          <li class>
            1 Planning
          </li>
        ...
        See also  Importance and Features of Activity Management
        ...
        See also  Importance and Steps of Controlling Function of Management
        <h5>3. Staffing</h5>
        ...
        See also  Advantages and Disadvantages of Management by Objectives (MBO)
        <h5>5. Controlling</h5>
        ...
        <h5>The controlling function involves:</h5>
        <ul>
          <li class>
    ...
    >
      ...
      <div class="col-md-12 p-4">
        <ul>
          ...
          <li class>
            Interest in field of Business Transactions, Management and Administration
          </li>
          <li class>
            Street smart personality with ability to work with a group of people as a team.
          </li>
        </ul>
      </div>
      <div class="col-md-12 mt-1">
