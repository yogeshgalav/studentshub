<template>
  <div class="row">
    ...
    <accordion
      title="Mental Healthcare/Rehabilitation Science"
      class="mb-2"
    >
      <p>Rehabilitation Science refers to cognitive, behavioral, and emotional well-being. It is all about how people think, feel, and behave. People sometimes use the term “mental health” to mean the absence of a mental disorder. Mental health can affect daily living, relationships, and physical health.</p>
    </accordion>
    <accordion
      title="Animal Healthcare/Veterinary Science"
      class="mb-2"
    >
      <div class="row">
        <div class="col-md-12">
    ...
    <accordion
      title="Plant Healthcare/Agricultural Science"
      class="mb-2"
    >
    ...
    <accordion
      title="Pharmacy/ParaMedical Science"
      class="mb-2"
    >
      <div class="row">
        <div class="col-md-12">
