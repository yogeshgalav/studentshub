...
<template>
  <section class="row">
    ...
    <!-- Header -->
    <div v-if="institute" id="institute_header" class="col-md-12">
      <div class="card">
        <div class="card-body p-4">
          <div class="">
            <img v-if="institute.profile_url" :src="institute.profile_url"
               style=" width: 100%; height: 185px; margin-bottom: -40px; border-radius: 15px " alt="">

            <img v-else-if="institute_banner_url" :src="institute_banner_url"
               style=" width: 100%; height: 185px; margin-bottom: -40px; border-radius: 15px;" alt="">

            <img  v-else src="/images/banner.png"
               style=" width: 100%; height: 185px; margin-bottom: -40px; border-radius: 15px " alt="">
            ...
            <file-upload
              ...
              @input="inputUpdate"
            >
                <img src="/images/cam-icon.svg" alt="" >
                    edit banner image
            </file-upload>
          </div>
          <div class="container">
              <img v-if="institute.avatar_url" :src="institute.avatar_url" alt="" >
              <img v-else-if="logo_url":src="logo_url" alt="" >
              <img v-else class="institute-avatar" 
                  src="/images/ins.png" alt="Student Hub" width="120 " height="120"
            ...
            >
                 <i class="fas fa-pencil-alt text-grey" style="color: white" />
            </button>
                   </h3>
                 <h5 style="margin: 5px 0px 0px 20px">
                   {{ institute.moto ? institute.moto : "Institute Moto" }}
                 </h5>
                   <p style="margin-left: 20px">{{ institute.description }}</p>
          <div>
            <div style="float: right">
              <ul class="social-network social-circle">
                ...
                <li>
                  <a target="_blank" :href="institute.twitter_url ? institute.twitter_url : '#'"
                ...
                <li>
                  <a target="_blank" :href=" institute.insta_url ? institute.insta_url : '#' "
                ...
                <li>
                  <a target="_blank" :href=" institute.linkedin_url   ? institute.linkedin_url :'#'" 
                ...
                <li>
                  <a target="blank":href=" institute.youtube_vedio_url ? institute.youtube_vedio_url : '#'"
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input v-model="institute.fb_url"
                    class="form-control"
                    type="text"
                  ...
                  <input v-model="institute.twitter_url"
                    class="form-control"
                    type="text"
                  ...
                  <input v-model="institute.insta_url"
                    class="form-control"
                    type="text"
                  ...
                  <input v-model="institute.linkedin_url"
                    class="form-control"
                    type="text"
                  ...
                  <input v-model="institute.youtube_vedio_url"
                    class="form-control"
                    type="text"
                  ...
                  <input id="website" v-model=" institute.website"
                    name="website"
                    class="form-control"
                    placeholder="http://website.com"
                  >
                  <label for="address">Address</label>
                  <input id="address" v-model=" institute.address"
                    name="address"
                    class="form-control"
...
<<<<<<< Updated upstream
    ...
    >
=======
    <div v-if="!institute" class="col-md-12">
>>>>>>> Stashed changes
      <div class="row">
    ...
    <div v-if="institute.id" class="col-md-12 mt-3">
      <nav-tabs
        :tabs="tabs"
      ...
      >
        ...
        <template slot="tab-panel-teachers">
          ...
          <div v-if="!teachers.length" class="row">
            <div class="col-md-10">
              <div class="card">
                <div class="card-body">
                  <p>
          ...
          <div v-else class="row">
            <div class="col-md-8 col-12">
              <div v-for="(teacher, index) in teachers" :key="index" class="card mb-2">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-2">
        ...
        <template slot="tab-panel-students">
          ...
          <div v-else class="row">
            <div class="col-md-8 col-12">
              <div v-for="(student, index) in students" :key="index" class="card mb-2" >
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-2">
                      <div class="text-center">
...
=======
          <div id="about-html">
            <div class="col-md-10">
              ...
              <div v-if="institute.blog" title="Blog">
                <div v-if="editPermission" class="edit-btn-row">
                  <button
                    v-if="isEdit"
                    type="button"
                  ...
                  >
                    <i class="fas fa-pencil-alt" style="color: white"/>
                    Edit
                  </button>
                  <button
                    v-else
                ...
                <div>
                  <div style="font-size: 15px; font-weight:800">
                    <div v-if="isEdit" id="app" v-html="institute.blog" />
                  </div>
                  <rich-text-editor
                    v-if="!isEdit"
                    id="ArticleEditor"
              ...
              <div  v-if="instituteVerified===true"
                ...
                <div class="card-body ">
                  ...
                  <div v-if="institute_users.length">
                    ...
                    >
                      ...
                      <div v-if="!isEdit" class="col-md-2 addAdmin">
                        <button
                          v-if="editPermission"
                          class="addAdmin"
                          data-toggle="modal"
                  ...
                  <div v-else>
                    <div class="row addAdmin">
                      <div v-if="editPermission" class="col-md-2">
                        <button
                          v-if="!isEdit"
                          class="addAdmin"
                          data-toggle="modal"
              ...
              <div v-if="institute.insta_url" title="Instagram">
                <div class="card-body">
                  <div class="col-md-3">
                    <blockquote
                      ...
                      <div style="padding: 16px">
                        <a href="https://www.instagram.com/reel/Ceq_zDhATZb/?utm_source=ig_embed&amp;utm_campaign=loading"
                          style="
                                  background: #ffffff;
                                  line-height: 0;
                                  padding: 0 0;
              ...
              <div title="Contact-Us" class="card">       
                <div class="card-body">
                  <div v-if="editPermission" class="edit-btn-row">
                  <button
                    type="button"
