<template>
  <div>
    <div class="mb-4">
      <router-link class="group flex items-center py-3" href="/">
    ...
    <div class="mb-4">
      <router-link class="group flex items-center py-3" href="/organizations">
    ...
    <div class="mb-4">
      <router-link class="group flex items-center py-3" href="/contacts">
    ...
    <div class="mb-4">
      <router-link class="group flex items-center py-3" href="/reports">
