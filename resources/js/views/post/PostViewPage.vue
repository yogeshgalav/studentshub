<template>
	<section class="single_post">
		...
		<div class="back_btn">
            <a class="btn btn-white btn-rounded btn-l" @click="$router.go(-1)"><i class="fa fa-arrow-left"></i> Back </a>
          ...
          <div class="single_post_head">
              	<h4 class="weight-400">{{postContent.subject_name}}</h4>
				      	<h2 class="weight-600">{{postContent.heading}}</h2>
								...
								<!-- <profile-image :postContent="post"/> -->
        	  ...
        	  <div class="info-post ml-2">
				...
				<h6 class="username weight-600">{{postContent.user_name}}   <span class="date text-muted weight-400 text-light-gray1">{{postContent.created_at}}</span> </h6>
			   </div>
        </div>
			</div>
			...
			<div class="col-md-12 col-12 center-col">
				<div class="row">
					<div class="col-md-8">
						...
						<div class="post_s_c">
						<div class="post_content"><p>{{postContent.video_content}}</p></div>  
	...
	<div class="bg-gray ptb-50">
        ...
        <div class="container">
          <div class="row">
<div  class="col-md-4">
    <div  class="card-post"><img  alt="Card image cap" class="card-img-top post_img_height" data-src="https://img.youtube.com/vi/SVQlcxiQlzI/0.jpg" src="https://img.youtube.com/vi/SVQlcxiQlzI/0.jpg" lazy="loaded">
        <div >
            <div  class=" mt-2">
