<template>
    <section class="single_post">
        <div class="post_view_head back_btn ">
            ...
            <div v-if="AuthUser" class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="#" @click="postSave()"
                        >Save</a
                    >
                    <a class="dropdown-item" href="#" @click="postReport()"
                        >Report</a
                    >
                </div>
            </div>
        ...
        <div class="single_post_page">
            <div class="container">
                ...
                <div class="social-network_singlepage">
                    ...
                    <social-sharing
                        :url="
                            'http://www.studentshub.in/post/' + postContent.id
                        "
                            ...
                            <div class="row">
                                ...
                                >
                                    <div class="recent_card_post">
                                        <h6
                                            class="card-title-tag  font-size-12"
                                        >
                                            <a href="#">
                                                {{ post.subject_name }}
                                            </a>
        ...
        <div v-if="AuthUser" class="single_page_user_like">
            <button
