<template>
    <div>
        <div class="containjr" role="main" v-show="url===''">
            <form enctype="multipart/form-data" novalidate class=" text-center box has-advanced-upload">
                <div class="box__input">
                    ...
                    <label for="documentUpload"><strong>Choose a file</strong><span class="box__dragndrop"> or drag it
                            here</span>.</label>
                </div>
                <file-upload id="documentUpload" class="btn btn-primary mt-3" post-action="/upload/post"
                    extensions="jpg,jpeg,png" accept="image/*" :drop="true" :size="1024 * 1024 * 10"
                    @input="inputUpdate" ref="upload">
                    Upload
                </file-upload>
            </form>
        </div>
        ...
        <div class="form-group fact_text">
            <div class="col-md-8">
                <textarea type="text" v-model="description" name="description" v-validate="'required'"
...
<style scoped>
  ...
  display: inline-block;
    ...
    .form-group.fact_text {
        margin-top: 30px;
    }

    .form-group.fact_text textarea {
        width: 100%;
        border-radius: 4px;
        height: 100px;
        padding: 10px 15px;
