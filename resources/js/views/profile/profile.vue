                ...
                <div class="row">
                    <div class="col-md-8 center-col">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="user_des">
                                    <h3 class="user_profile_name"> {{user.full_name}} <span @click="openProfileEditModal" v-if="user.id===AuthUser.id"><i class="fas fa-edit"></i></span></h3>
                                    <p>{{user.introduction}}</p>
                                    <p v-if="!user.introduction && user.id===AuthUser.id">Write Something about yourself. What are your hobbies. 
                ...
                <div class="user_interest">
                    ...
                    <div class="user_int">
                        <div class="user_int_text">
                            <p v-show="user.id===AuthUser.id">This data is generated by your interaction with posts,hence the more you interect with
                                posts the more
                                precise this data is.</p>
                            <p v-if="interests.length===0 && user.id===AuthUser.id">Currently we don't have enough data to analys your interest.
