	...
	<div class="welcome_post_sec">
		...
		<div v-for="(post,index) in posts" :key="index">
			<div  class="row">
						...
						<div>
							<div class="d-flex mt-2">
								...
								<div class="info-post ml-2">
									...
									<p class="mb-1 post_cat_size">{{post.subject_name}}</p>
				...
				<div class="col-md-3">
					<img class="card-img-top wel_post_img" v-lazy="post.image_path" alt="Card image cap">
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
...
<style scoped>
	...
	.welcome_post_sec .row{align-items: center;}
