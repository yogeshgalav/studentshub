<template>
    <div class="col-md-8 col-center">
        <div v-if="daily_report===null && daily_assignment===null">
            <div id="reflection-complete" class="card mt-3 mb-3  bg-success ">
  ...
  <div class="card mt-3 mb-3  bg-default ">
             ...
             <div
                      ...
                      <div class="col-md-12">
                       ...
                       <div class="col-md-1" >
                          ...
                          <div class="col-md-3">{{choice.option_text}}</div>
                           <div class="col-md-3" v-if="choice.is_correct"><i class="fa fa-check text-success"></i> </div>
                           <div class="col-md-3" v-else><i class="fa fa-times text-danger"></i> </div>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-12">
<p class="text-black mb-1"> Marks obtained : <span class="text-success weight-800"> {{ daily_report.marks_obtained }} </span> | Rank : <span class="text-success weight-800"> {{ daily_report.rank }} </span></p>
        ...
        <div v-if="daily_report===null && daily_assignment!==null">
            <div id="reflection-incomplete" class="card mt-3 mb-3 bg-primary border-primary">
                <div class="card-header ">
                    <h3 class="text-center font-size-18 text-white">
                        {{ 'Daily Assignment' }}
                    </h3>
                        ...
                        <div class="col-md-12 col-12 center-col">
                            <div class="row">
                                <div class="col-md-12 col-lg-12 col-12 text-center">
                                    ...
                                    <a id="reflection-link" class="btn btn-success text-white"
