                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="inner-addon left-addon">
                                                <div class="input_icon_frm">
                                                    ...
                                                    <input type="text" v-model="classroom_name" name="classroom_name" v-validate="'required'">
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="inner-addon left-addon">
                                                <div class="input_icon_frm">
                                                    <span class="icon_design_input" style="height: 44px;"> <i
                                                            class="fa fa-certificate" aria-hidden="true"></i></span>
                                                    <input type="text" v-model="classroom_id" name="classroom_id" v-validate="'alpha_num|required'">
                                                </div>
                                                <span class="error">{{ formErrors('classroom_id') }}</span>
                                            </div>
                                        </div>
