                                        ...
                                        <form @submit.prevent="handleSubmit">
                                                ...
                                                <div class="inner-addon left-addon">
                                                    <div class="input_icon_frm">
                                                        ...
                                                        <input id="full_name" type="text" class="form-control"
                                                            name="full_name" placeholder="Enter Full Name" autofocus
                                                            v-validate="'required'" v-model="full_name" />
                                                    </div>
                                                ...
                                                <div class="inner-addon left-addon ">
                                                    <div class="input_icon_frm">
                                                        ...
                                                        <input id="password" ref="password" type="password"
                                                            class="form-control" name="password" v-validate="'required'"
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="login_btn_part">
                                                    <button type="submit" class="login_btn">{{ trans('Register') }} <i
