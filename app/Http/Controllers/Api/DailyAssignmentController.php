...
class DailyAssignmentController extends Controller
{
    ...
    public function getDailyAssismentReports(Request $request){
        ...
        ->rightjoin('daily_answers as dans','dq.id','=','dans.daily_question_id')
        ->select('dq.daily_assignment_id as daily_assignment_id','dq.id as question_id','dans.selected_answer as selected_answer',DB::raw('COUNT(distinct dans.id) as count'))
